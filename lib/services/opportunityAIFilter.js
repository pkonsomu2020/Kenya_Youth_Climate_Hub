...
2. **is_approved** (true/false): Approve if climate_score >= 0.5 AND deadline is in the future (or unknown).
   ...
   - CRITICAL: REJECT vague roundup/listicle posts covering many unrelated opportunities at once (e.g. "40+ Grant Opportunities for Capacity Building", "June Funding Roundup: 141 New Opportunities!", "13 Global Scholarships and Fellowships Currently Open"). Approve only a post about ONE specific, named opportunity with an identifiable provider.
   - CRITICAL: REJECT generic organization/company profile pages or personal bios/posts that are not themselves an announcement of one specific opportunity.

3. **topic**: Best matching topic from: Energy, Water, Agriculture, Policy, Finance, Innovation, Resilience, Advocacy, Waste, Data

4. **deadline**: Extract the EXACT deadline date if mentioned in the title, excerpt, or the "raw_date" field (a date scraped directly from the page — prefer it over guessing from text, but note it may be an unrelated page/article date, so use judgment) (e.g. "Jun 15, 2026", "May 30, 2026").
