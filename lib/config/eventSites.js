...
const EVENT_SITES = [
  ...
  {
    id: "rss-kenya-events-nairobi",
    name: "Google News",
    url: "https://news.google.com/rss/search?q=climate+event+conference+summit+nairobi+kenya+2025+2026&hl=en-KE&gl=KE&ceid=KE:en",
    category: "In-Person",
    isRSS: true,
  },
  {
    ...
    name: "Google News",
    url: "https://news.google.com/rss/search?q=Artificial+Intelligence+AI+tech+event+summit+conference+kenya+africa+2026&hl=en-KE&gl=KE&ceid=KE:en",
    category: "In-Person",
    isRSS: true,
  },
  {
    ...
    name: "Google News",
    url: "https://news.google.com/rss/search?q=(climate+OR+AI)+change+webinar+virtual+event+youth+global+2026&hl=en&gl=US&ceid=US:en",
    category: "Virtual",
    isRSS: true,
  },
];
